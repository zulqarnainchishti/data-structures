...
char *cll_to_string(const CircularLinkedList *list)
{
...
void test_init_and_clear()
{
    ...
    char *s = cll_to_string(&list);
    ASSERT_STRING(s, "[empty]", "Empty list string representation.");
    free(s);

    clear(&list);
    ASSERT_PTR_NULL(list.tail, "clear() on empty list should keep tail NULL.");
    ...
    s = cll_to_string(&list);
    ASSERT_STRING(s, "[0] -> [1] -> [2]", "List content before clear.");
    free(s);

    clear(&list);
    ASSERT_PTR_NULL(list.tail, "clear() on populated list should set tail to NULL.");
...
void test_insert_at_start()
{
    ...
    free(s);
    ASSERT_INT(list.tail->data, 10, "Tail should be 10 for single node list.");
    ASSERT_INT(list.tail->next->data, 10, "Head should be 10 for single node list.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 10, "Tail should still be 10.");
    ASSERT_INT(list.tail->next->data, 5, "Head should be 5.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 10, "Tail should still be 10.");
    ASSERT_INT(list.tail->next->data, 1, "Head should be 1.");
...
void test_insert_at_end()
{
    ...
    free(s);
    ASSERT_INT(list.tail->data, 20, "Tail should be 20.");
    ASSERT_INT(list.tail->next->data, 10, "Head should be 10.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 30, "Tail should be 30.");
    ASSERT_INT(list.tail->next->data, 10, "Head should be 10.");
...
void test_insert_at_index()
{
    ...
    free(s);
    ASSERT_INT(list.tail->data, 50, "Tail should be 50.");
    ASSERT_INT(list.tail->next->data, 50, "Head should be 50.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 50, "Tail should still be 50.");
    ASSERT_INT(list.tail->next->data, 10, "Head should be 10.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 100, "Tail should be 100.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 100, "Tail should still be 100.");
...
void test_insert_after_value()
{
    ...
    free(s);
    ASSERT_INT(list.tail->data, 40, "Tail should remain 40.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 45, "Tail should now be 45.");
    ...
    free(s);
    ASSERT_INT(list.tail->next->data, 10, "Head should remain 10.");
...
void test_delete_start()
{
    ...
    ASSERT_PTR_NULL(list.tail, "Tail should remain NULL for empty list.");
    ...
    ASSERT_PTR_NULL(list.tail, "Tail should be NULL after deleting last node.");
    s = cll_to_string(&list);
    ...
    free(s);
    ASSERT_INT(list.tail->next->data, 20, "New head should be 20.");
    ASSERT_INT(list.tail->data, 30, "Tail should remain 30.");
    ...
    free(s);
    ASSERT_INT(list.tail->next->data, 30, "New head should be 30.");
    ASSERT_INT(list.tail->data, 30, "Tail should be 30.");
...
void test_delete_end()
{
    ...
    free(s);
    ASSERT_INT(list.tail->data, 20, "New tail should be 20.");
    ASSERT_INT(list.tail->next->data, 10, "Head should remain 10.");
    ...
    free(s);
    ASSERT_INT(list.tail->data, 10, "New tail should be 10.");
    ASSERT_INT(list.tail->next->data, 10, "Head should be 10.");
...
void test_delete_value()
{
    ...
    ASSERT_PTR_NULL(list.tail, "Tail should be NULL after deleting only element.");
    s = cll_to_string(&list);
    ...
    free(s);
    ASSERT_INT(list.tail->next->data, 30, "Head should be 30.");
...
void test_search()
{
    ...
    CLLNode *found_node = search(&list, 10);
...
void test_reverse()
{
    ...
    ASSERT_PTR_NULL(list.tail, "Tail should be NULL after reversing empty list.");
    s = cll_to_string(&list);
    ...
    free(s);
    ASSERT_INT(list.tail->data, 100, "Tail should still be 100.");
    ASSERT_INT(list.tail->next->data, 100, "Head should still be 100.");
    clear(&list);
    ...
    free(s);
    ASSERT_INT(list.tail->data, 10, "New tail should be original head (10).");
    ASSERT_INT(list.tail->next->data, 40, "New head should be original tail (40).");
...
{
    printf("--- Test: copy ---\n");
    CircularLinkedList list1 = init();
    char *s1 = NULL, *s2 = NULL;

    CircularLinkedList list_empty_copy = copy(&list1);
    ASSERT_INT(list_empty_copy.length, 0, "Copied empty list should have length 0.");
    ASSERT_PTR_NULL(list_empty_copy.tail, "Copied empty list should have NULL tail.");
    s1 = cll_to_string(&list_empty_copy);
    ...
    {
        ASSERT_VERBOSE(list1.tail->next != list2.tail->next, "Head pointers should be different (deep copy).", "Different", "Same");
        ASSERT_VERBOSE(list1.tail != list2.tail, "Tail pointers should be different (deep copy).", "Different", "Same");

        CLLNode *curr1 = list1.tail->next;
        CLLNode *curr2 = list2.tail->next;
        ...
        do
        {
            ...
            curr1 = curr1->next;
            curr2 = curr2->next;
        } while (curr1 != list1.tail->next && curr2 != list2.tail->next);
...
int main()
{
    printf(CYAN "\n===== CIRCULAR LINKED LIST TEST SUITE =====\n\n" RESET);
